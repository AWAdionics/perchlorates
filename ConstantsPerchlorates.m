classdef ConstantsPerchlorates
    properties (Constant)
        ...
        TKapp1 = mvu(40,' C')
        TKapp2 = mvu(80,' C')
        Kapp1 = mvu([0.5*4.9268e+07,8*8.3334e+12,100*2.9709e+08],'')%mvu([40113,2342300,23581000],'')
        %Kapp1 = mvu(100*[40113*5,2342300*5,2358100],'')%mvu([40113,2342300,23581000],'')
        Kapp2 = mvu([29.9122,628.8899,98.5774],'')%mvu([17.20692,53.56554,33.33496],'')
    end
end